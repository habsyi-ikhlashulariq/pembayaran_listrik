			...
			<tr>
				<td>
					...
					<tr>
						...
						<td colspan="8"><a href="tambah_pelanggan.php">Tambah Daya Listrik</a><input type="text" name="tcari" placeholder="Masukan Daya Listrik" class="tcari"><input type="submit" name="bcari" value="cari" class="bcari"></td>
						</form>
						<?php 
						 ?>
					</tr>
						...
						<td class="opsi">OPSI</td>
							...
							<?php 
								if (isset($_POST['bcari'])) {
									...
									$no = 1;
									$sql2 = 'SELECT * FROM listrik WHERE daya like "%'.$cari.'%"';
