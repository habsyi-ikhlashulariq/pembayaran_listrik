		...
		<table>
			...
			<tr>
				<td>
					...
					<tr>
						<form method="POST" action="aksi_cari_pelanggan.php">
					...
					$no = 1;
					$id2 = $_SESSION['id'];
					$sql2 = 'SELECT * FROM pelanggan WHERE level="client"';
					$query2 = mysqli_query($koneksi, $sql2);
					while ($data2 = mysqli_fetch_array($query2)) {
					?>
						<tr>
							<td><?php echo $no++; ?></td>
							<td><a href="#" onclick="window.open('laporan_pembayaran_pelanggan.php?id=<?php echo $data2['id'];?>');return false;" class="link"><?php echo $data2['nama']; ?></a></td>
